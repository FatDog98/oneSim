...
public class BubbleRap_UTS implements RoutingDecisionEngine, CommunityDetectionEngine, CentralityGlobal {
    ...
    public BubbleRap_UTS(Settings s) {
    ...
    public BubbleRap_UTS(BubbleRap_UTS proto) {
    ...
    public void doExchangeForNewConnection(Connection con, DTNHost peer) {
        ...
        BubbleRap_UTS de = this.getOtherDecisionEngine(peer);
    ...
    public boolean shouldSendMessageToHost(Message m, DTNHost otherHost, DTNHost thisHost) {
        ...
        BubbleRap_UTS de = getOtherDecisionEngine(otherHost);
    ...
    public boolean shouldDeleteSentMessage(Message m, DTNHost otherHost) {
        ...
        BubbleRap_UTS de = this.getOtherDecisionEngine(otherHost);
    ...
    private BubbleRap_UTS getOtherDecisionEngine(DTNHost h) {
        MessageRouter otherRouter = h.getRouter();
        assert otherRouter instanceof DecisionEngineRouter : "This router only works "
                + " with other routers of same type";

        return (BubbleRap_UTS) ((DecisionEngineRouter) otherRouter).getDecisionEngine();
    }
